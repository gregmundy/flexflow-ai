...
export default function Home() {
  ...
  return (
    <div className="page-gradient-light">
      {/* Hero Section */}
      <section className="container mx-auto px-4 pt-20 pb-16 md:pb-20 text-center">
        ...
        >
          <Badge variant="secondary" className="mb-4 text-sm font-medium glass-card-subtle border-0 glass-text-primary">
            No App Required • Just Text Messages
          </Badge>
          
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold glass-text-primary mb-6 leading-tight max-w-4xl mx-auto">
          ...
          <p className="text-xl glass-text-secondary mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="max-w-md mx-auto mb-8">
            <Card variant="glass" animation="fade-in" className="p-6">
          ...
          <div className="text-center mb-8">
            <p className="glass-text-secondary mb-4">or</p>
          ...
          <p className="text-sm glass-text-primary mb-4 font-medium">
            <strong>$25/month billed monthly</strong> • Cancel anytime • No long-term commitment required
          </p>

          {/* Trust Indicators */}
          <div className="flex items-center justify-center gap-6 text-sm glass-text-secondary">
      ...
      <section className="py-8 px-4 md:px-8">
        <div className="max-w-4xl mx-auto">
          <Card variant="glass-subtle" className="p-4 text-sm border-l-4 border-l-yellow-500">
            <p className="font-semibold glass-text-primary mb-2">Important Health Notice:</p>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold glass-text-primary mb-4">
              Why SMS Instead of Another App?
            </h2>
            <p className="text-lg glass-text-secondary max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card variant="glass" animation="slide-up" className="text-center h-full">
                  <CardHeader>
                    <div className="mx-auto mb-4 p-3 glass-card-subtle rounded-full w-fit">
                      {feature.icon}
                    </div>
                    <CardTitle variant="glass" className="text-lg md:text-xl font-semibold">{feature.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <CardDescription variant="glass" className="text-sm leading-relaxed">
                      {feature.description}
                    </CardDescription>
                  </CardContent>
                </Card>
      ...
      {/* AI Trainers Showcase - Enhanced with Glass Morphism */}
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
            {trainers.map((trainer, index) => (
              ...
              >
                <Card variant="glass-interactive" animation="fade-in" className="h-full transition-all duration-300 overflow-hidden">
                  <CardHeader className="pb-4 lg:pb-6">
                    {/* Enhanced Header with Larger Image */}
                    <div className="flex items-start gap-5 mb-6">
                      {/* Larger Circular Avatar */}
                      <div className="relative flex-shrink-0">
                        <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-full overflow-hidden glass-card-subtle ring-2 ring-white/20">
                          <Image
                            src={trainer.image}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-3">
                          <Badge 
                            variant="outline" 
                            className={`text-xs font-bold border-0 px-3 py-1.5 glass-card-subtle glass-text-primary shadow-sm ${trainer.color}`}
                          >
                            {trainer.name}
                          </Badge>
                        </div>
                        <CardTitle variant="glass" className="text-lg sm:text-xl font-bold leading-tight mb-1">
                          {trainer.personality}
                        </CardTitle>
                      </div>
                    </div>
                    ...
                    <CardDescription variant="glass" className="text-sm leading-relaxed mb-4">
                      {trainer.description}
                    </CardDescription>
                  </CardHeader>
                  ...
                  <CardContent className="pt-0">
                    ...
                    <div className="glass-card-subtle rounded-xl p-5 border-l-4 border-l-purple-400/30">
                      <p className="text-sm leading-relaxed font-medium italic glass-text-secondary">
                        &quot;{trainer.style}&quot;
                      </p>
                    </div>
                  </CardContent>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 items-start">
              {[
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-lg font-bold mx-auto mb-4 glass-card shadow-lg">
                    {item.step}
                  </div>
                  <h3 className="text-lg md:text-xl font-semibold glass-text-primary mb-2">
                    {item.title}
                  </h3>
                  <p className="glass-text-secondary max-w-prose leading-relaxed">
                    {item.description}
                  </p>
                </motion.div>
              ))}
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl md:text-3xl font-bold glass-text-primary mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
              {[
                ...
                >
                  <div className="p-3 glass-card rounded-full shadow-md text-blue-600">
                    {benefit.icon}
                  </div>
                  <p className="text-sm font-medium glass-text-primary">{benefit.text}</p>
                </motion.div>
              ))}
            </div>

            <Card variant="glass-elevated" className="p-8 shadow-lg max-w-2xl mx-auto">
              <p className="text-lg glass-text-secondary mb-4 leading-relaxed">
          ...
          >
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="glass-card rounded-lg px-6 border-0">
                <AccordionTrigger className="text-left text-base md:text-lg font-semibold glass-text-primary hover:no-underline">
                  How does FlexFlow work exactly?
                </AccordionTrigger>
                <AccordionContent className="glass-text-secondary leading-relaxed">
              ...
              <AccordionItem value="item-6" className="glass-card rounded-lg px-6 border-0">
                <AccordionTrigger className="text-left text-base md:text-lg font-semibold glass-text-primary hover:no-underline">
      ...
      {/* Final CTA */}
      <section className="py-16 md:py-20 page-gradient-purple">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            viewport={{ once: true }}
          >
            <Card variant="glass-purple" className="p-8 max-w-2xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 glass-text-primary">
                Ready to Start Your Fitness Journey?
              </h2>
              <p className="text-xl mb-8 glass-text-secondary max-w-2xl mx-auto leading-relaxed">
      ...
      {/* Footer */}
      <footer className="py-8 glass-nav">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h3 className="text-lg md:text-xl font-bold glass-text-primary mb-2">FlexFlow</h3>
            <p className="text-sm mb-4 glass-text-secondary">
